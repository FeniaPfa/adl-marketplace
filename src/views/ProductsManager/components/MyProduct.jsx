            ...
            <Paper sx={{ padding: '1.5rem 2rem' }}>
                <Stack
                    ...
                    <Stack gap="2rem" alignItems="center" sx={{ flexDirection: { xs: 'column', sm: 'row' } }}>
                        <Avatar src={image} sx={{ width: '150px', height: '150px' }} variant="rounded" alt={product.sport} />
