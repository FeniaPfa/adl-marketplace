...
export const ProductCard = ({ product }) => {
    ...
    return (
        <Card
            ...
            onClick={handleClick}>
            <CardMedia component="img" sx={{ height: '250px', minWidth: '200px' }} image={image} alt={product.dojo} />
            ...
            <CardContent>
                <Stack gap=".3rem" alignItems="center">
                    ...
                    <Typography variant="h4" fontWeight="bold" color="primary" sx={{ letterSpacing: '.3rem' }}>
